...
export default function TaskItem({
     ...
     return (
          <div
               className="flex gap-3 text-lg rounded-xl justify-between bg-slate-50 dark:bg-slate-800 transition-all duration-300 lg:hover:bg-slate-100 lg:dark:hover:bg-slate-600 shadow-md p-3 w-full xl:w-2/3"
               draggable={true}
               id={id}
